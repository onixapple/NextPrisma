...
const [priceInCents, setPriceInCents] = useState<number | undefined>(product?.priceInCents)
    ...
    return <form action={action}>
        ...
        <div className = "space-y-2">
            ...
            <Input type = "number" id = "priceInCents" name = "priceInCents" required value = {priceInCents} onChange ={
                e => setPriceInCents(Number(e.target.value) || undefined)}/>
        ...
        <div className = "space-y-2">
            ...
            {product != null && <Image src= {product.imagePath} height={400} width={400}  alt="Picture of the author"/>}
