    ...
    return <Table>
        <TableHeader>
            <TableRow>
                ...
                <TableHead className="w-0">Price</TableHead>
            ...
            {products.map(product => (
                <TableRow key={product.id}>
                    <TableCell>{product.isAvailableForPurchase ? <>
                        <span className="sr-only">Available</span><CheckCircle2 /></> : <><span className="sr-only">Unavailable</span><XCircle className="stroke-destructive"/></>}
                    </TableCell>
