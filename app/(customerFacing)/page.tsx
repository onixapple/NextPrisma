...
export default function HomePage() {
    return <main className="space-y-12">
        <ProductGridSection title="Most popular products" productsFetcher={getMostPopularProducts} />
        <ProductGridSection title="Newest products" productsFetcher={getNewestProducts} />
    </main>
}

type ProductGridSectionPropos = {
    title: string
    productsFetcher: () => Promise<Product[]>
}

function ProductGridSection({ productsFetcher, title }: ProductGridSectionPropos) {
